...
void main() {
    ...
    float freqs[4];
    //Sound
    freqs[0] = texture2DRect( tex01, vec2( 0.01, 0.25 ) ).x;
    freqs[1] = texture2DRect( tex01, vec2( 0.07, 0.25 ) ).x;
    freqs[2] = texture2DRect( tex01, vec2( 0.15, 0.25 ) ).x;
    freqs[3] = texture2DRect( tex01, vec2( 0.30, 0.25 ) ).x;
